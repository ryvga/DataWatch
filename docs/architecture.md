...
values instead of interpolated SQL. ClickHouse and Trino additionally run real-container
verticals. Public capability metadata is generated by reflection over executable adapter
methods/dialect declarations and is checked against
`docs/evidence/connector-capabilities.generated.json`, rather than duplicated manually in
the registry.
